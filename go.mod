...
require (
	...
	buf.build/gen/go/webitel/storage/grpc/go v1.3.0-20240522091716-22d1ec485218.3
	buf.build/gen/go/webitel/storage/protocolbuffers/go v1.34.1-20240522091716-22d1ec485218.1
