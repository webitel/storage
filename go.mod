...
require (
	...
	buf.build/gen/go/webitel/storage/grpc/go v1.4.0-20240611095007-63958cffd377.1
	buf.build/gen/go/webitel/storage/protocolbuffers/go v1.34.1-20240611095007-63958cffd377.1
