...
require (
	...
	buf.build/gen/go/webitel/storage/grpc/go v1.5.1-20241029082001-4bec0c722ead.1
	buf.build/gen/go/webitel/storage/protocolbuffers/go v1.35.1-20241029082001-4bec0c722ead.1
