...
require (
	...
	buf.build/gen/go/webitel/storage/grpc/go v1.5.1-20241026124749-76b39a56f571.1
	buf.build/gen/go/webitel/storage/protocolbuffers/go v1.35.1-20241026124749-76b39a56f571.1
