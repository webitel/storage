...
require (
	buf.build/gen/go/webitel/engine/protocolbuffers/go v1.36.3-20240402125447-cb375844242f.1
	buf.build/gen/go/webitel/storage/grpc/go v1.5.1-20250124080124-f3b236d30be3.2
	buf.build/gen/go/webitel/storage/protocolbuffers/go v1.36.3-20250124080124-f3b236d30be3.1
