...
require (
	...
	buf.build/gen/go/webitel/storage/grpc/go v1.3.0-20240509104502-4224567c84e2.3
	buf.build/gen/go/webitel/storage/protocolbuffers/go v1.34.1-20240509104502-4224567c84e2.1
